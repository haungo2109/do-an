...
export const auctionAuctionAction = createAsyncThunk(
	'auction/auctionAuction',
	async (data) => {
		const response = await auctionApi.auctionAuction(data);
		return response;
	}
);
...
const auctionSlice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(auctionAuctionAction.fulfilled, (state, action) => {
		...
		builder.addCase(auctionAuctionAction.rejected, (state, action) => {
		...
		builder.addCase(auctionAuctionAction.pending, (state, action) => {
